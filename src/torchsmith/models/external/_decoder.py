"""
Credits: Berkeley RLL
Taken with import modifications to be able to load the colored MNIST pre-trained VQVAE.
"""
...
from torchsmith.models.external._residual import ResidualStack
